 ...
 * @author Asus
 */
@WebFilter(filterName = "sessionManagement", urlPatterns = {"/*"})
public class sessionManagement implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (session.getAttribute("token") != null && session.getAttribute("idUser") != null) {
            ...
            //Connect to validateToken servlet
            ...
            if ("true".equals(str_token)) {
                if ("true".equals(str_expire)) {
                    ...
                    if ("/index.jsp".equals(page)) {
                       sResponse.sendRedirect("/saleProject/viewKatalog.jsp");
                       return;
                    }
                }
            }
